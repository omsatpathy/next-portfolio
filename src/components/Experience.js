        ...
        <div className='my-64 '>
            ...
            <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    <li>
                        <Details 
                            position="Software Engineer" company="Google" companyLink="www.google.com"
                        ...
                        />
                        <Details 
                            position="Intern" company="Facebook" companyLink="www.facebook.com"
                        ...
                        />
                        <Details 
                            position="Software Developer" company="Amazon" companyLink="www.amazon.com"
                        ...
                        />
                        <Details 
                            position="Software Developer Intern" company="Microsoft" companyLink="www.microsoft.com"
