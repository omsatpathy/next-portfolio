...
import profilePic from  "../../public/images/profile/om-portfolioPic.jpg"
...
const about = () => {
    return (
        <>
            <Head>
                <title>Om Satpathy | About page</title>
                ...
                <Layout className="pt-16">
                    ...
                    <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
                        <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
                            <h2 className="mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75">Biography</h2>
                                <p className="font-medium">
                                    - Hi, I&apos;m Om Satpathy, a full stack web and app developer with a passion for creating beautiful, functional, 
                                    and user-centered digital experiences. With 2 year of experience in the field. I am always looking for 
                        ...
                        dark:border-light xl:col-span-4 md:order-1 md:col-span-8">
                            ...
                            <Image src={profilePic} alt="om" className="w-full h-auto rounded-2xl"
                            priority 
