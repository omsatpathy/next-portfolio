...
const Skills = () => {
  return (
    <>
        <h2 className='font-bold text-8xl mt-64 w-full text-center ms:text-6xl md:mt-32'>Skills</h2>
        ...
        <Skill name="ReactJS" x="3vw" y="-15vw"/>
        <Skill name="ExpressJS" x="15vw" y="12vw"/>
        <Skill name="Flutter" x="-31vw" y="-2vw"/>
        <Skill name="Sanity" x="30vw" y="5vw"/>
        <Skill name="TailwindCSS" x="-22vw" y="-14vw"/>
        <Skill name="GraphQL" x="5vw" y="19vw"/>
        </div>
    </>
  )
}
